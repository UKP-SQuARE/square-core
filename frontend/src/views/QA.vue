      ...
      <div class="col-md-8 mx-auto mt-4 text-center">
        <div class="bg-light border rounded shadow p-5 text-center">
          <div class="feature-icon bg-danger bg-gradient">
            <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" class="bi bi-question-lg"
              viewBox="0 0 16 16">
          ...
          <p class="lead fs-2">Try <span class="text-danger">extractive</span>, <span class="text-danger">multiple
              choice</span>, and <span class="text-danger">categorical</span> skills.</p>
