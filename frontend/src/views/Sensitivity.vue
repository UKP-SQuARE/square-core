                  ...
                  <div class="bg-light border border-secondary rounded h-100 p-3">
                    <div class="w-100">
                      <div class="row">
                        ...
                        <div class="row g-0" v-for="(choice, index) in listPerturbedInput" :key="index" id="perturbed_loop">
                          <div class="col-sm">
                            <div class="input-group input-group-sm mb-3 px-3">
                              <span class="input-group-text" id="basic-addon1">{{ index + 1 }}</span>
                              <input v-model="listPerturbedInput[index]" type="text" class="form-control form-control-sm"
                                required>
                            </div>
                          </div>
                        </div>
