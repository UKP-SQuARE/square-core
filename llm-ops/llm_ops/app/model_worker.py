...
from llm_ops.prompts.conversation import get_conv_template
...
class BaseModelWorker:
    def __init__(
        ...
        if conv_template:
            ...
            # self.conv.set_system_message("You are a helpful, respectful and honest assistant.")
            # print(self.conv)
...
def create_model_worker():
    ...
    parser.add_argument(
        "--dev_mode",
        action="store_true",
        help="run in dev mode for debugging"
    )
