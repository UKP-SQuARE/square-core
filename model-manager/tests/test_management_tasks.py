...
class TestTasks(unittest.TestCase):
    ...
    def setUp(self) -> None:
        ...
        self.patcher1 = patch('app.db.database.MongoClass.get_model_container_ids')
    ...
    @patch('app.db.database.MongoClass.server_info', return_value=True)
    @patch('app.db.database.MongoClass.remove_model_db', return_value=None, new_callable=AsyncMock)
    ...
    @patch('app.db.database.MongoClass.remove_container', return_value=None, new_callable=AsyncMock)
