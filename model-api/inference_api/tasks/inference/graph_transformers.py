...
<<<<<<< HEAD:model-api/inference_api/tasks/inference/graph_transformers.py
        # edges = [
...
>>>>>>> origin/master:square-model-inference-api/inference_server/tasks/inference/graph_transformers.py
        edge_attributes = {}
