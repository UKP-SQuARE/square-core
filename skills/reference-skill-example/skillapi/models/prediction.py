...
class PredictionOutput(BaseModel):
    output: str = Field(
        ...,
        description="The actual output of the model as string. Could be an answer for QA, an argument for AR or a label for Fact Checking."
    )
...
class QueryOutput(BaseModel):
    ...
    predictions: List[Prediction] = Field(
        ...,
        description="All predictions for the query"
    )
