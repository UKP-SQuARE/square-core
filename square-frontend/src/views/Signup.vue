  ...
  <div class="d-flex justify-content-center">
    <div class="card border-primary shadow align-self-center text-center" style="width: 362px;">
      ...
      <div class="card-body p-4">
        <Alert v-if="success" class="alert-success">Your account was created successfully!</Alert>
        ...
        <div class="row mt-1">
          <div class="col">
            <router-link to="/signin" role="button" class="btn btn-outline-primary w-100">Sign in</router-link>
          </div>
        </div>
      </div>
    </div>
